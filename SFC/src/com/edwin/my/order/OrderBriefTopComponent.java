 ...
 */
@ConvertAsProperties(
    dtd = "-//com.edwin.my.order//OrderBrief//EN",
autostore = true)
...
@ActionID(category = "Window", id = "com.edwin.my.order.OrderBriefTopComponent")
...
public final class OrderBriefTopComponent extends TopComponent {
