...
//                + "AND TB003=?  AND TB005<=TB004");
        Query query = s.createSQLQuery("SELECT SUM(ISNULL(dbo.fn_me_GetMoctbCapable(TB001,TB002,TB003),0)) TTE\n"
                + "			FROM  MOCTB\n"
                + "			LEFT JOIN MOCTA ON TB001=TA001 AND TB002=TA002\n"
...
//                + "AND TB003=?  \n"
//                + "ORDER BY TA009";
        String kbgdsql = "SELECT TB001,TB002, dbo.fn_me_GetMoctbCapable(TB001,TB002,TB003) GDKBL,TA009\n"
                + "			FROM  MOCTB\n"
                + "			LEFT JOIN MOCTA ON TB001=TA001 AND TB002=TA002\n"
                + "			WHERE TA030='1' AND TA013='Y' AND TA011<>'Y' AND TA011<>'y' AND TA011<>'1' AND EXISTS (SELECT TC004+TC005 FROM SFCTC WHERE TC004=MOCTA.TA001 AND TC005=MOCTA.TA002 AND TC022='Y')\n"
                + "			AND TB003=?\n"
